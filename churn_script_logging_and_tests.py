'''
Module contain function to test churn libary script
Author : FSQ
Date : 7th Augst 2022
'''
import os
...
def test_train_models():
    ...
    try:
        assert os.path.isfile('./images/results/LogisticRegressionResult.png') is True
        logging.info('File %s was found', 'LogisticRegressionResult.png')
    except AssertionError as err:
        logging.error('Not such file on disk')
        raise err
